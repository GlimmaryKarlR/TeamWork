...
export const NODE_RECOMMENDATIONS: Record<string, NodeTeamRecommendation> = {
  'sci-1': {
    ...
    teamLabel: 'Empirical STEM Unit',
    rationale: 'Pairs high-speed multi-variable mathematical formulation with rigorous analytical derivation.',
    recommendedRoleAlpha: 'Empirical Modeler',
    recommendedRoleBeta: 'Analytical Verifier',
  },
  'sci-2': {
    nodeId: 'sci-2',
    ...
    teamLabel: 'Statistical Modeling Lab',
    rationale: 'Combines deep mathematical proof exploration with structured numerical kinetics validation.',
    recommendedRoleAlpha: 'Theoretical Mathematician',
    recommendedRoleBeta: 'Applied Numerical Auditor',
  },
  'sci-3': {
    nodeId: 'sci-3',
    primaryAlphaId: 'deepseek-r1',
    ...
    teamLabel: 'First-Principles Taskforce',
    rationale: 'Anchors quantum and physical derivations in axiomatic theorems verified at ultra-low latency.',
    recommendedRoleAlpha: 'Foundational Physicist',
    recommendedRoleBeta: 'Dimensional Analysis Lead',
  },
  'log-1': {
    nodeId: 'log-1',
    ...
    teamLabel: 'Invariant Verification Squad',
  ...
  'log-2': {
    ...
    freeAlphaId: 'deepseek-r1-free',
    freeBetaId: 'qwen-2.5-72b-free',
    teamLabel: 'Decision Tree Optimizer',
    ...
    recommendedRoleBeta: 'Tree Search Specialist',
  },
  'log-3': {
    nodeId: 'log-3',
    ...
    freeBetaId: 'deepseek-r1-free',
    teamLabel: 'Strategic Reasoning Group',
  ...
  'cod-1': {
    ...
    freeAlphaId: 'qwen-2.5-72b-free',
    freeBetaId: 'llama-3.3-70b-free',
    teamLabel: 'Algorithmic Synthesis Core',
  ...
  'cod-2': {
    ...
    teamLabel: 'Concurrent Systems Engine',
    rationale: 'Builds thread-safe asynchronous architectures and event-driven distributed conduits.',
  ...
  'cod-3': {
    ...
    freeAlphaId: 'qwen-2.5-72b-free',
    freeBetaId: 'deepseek-r1-free',
    teamLabel: 'Production Reliability Brigade',
    ...
    recommendedRoleBeta: 'Failure Mode Auditor',
  },
  'hum-1': {
    nodeId: 'hum-1',
    primaryAlphaId: 'gpt-4o',
    ...
    freeAlphaId: 'llama-3.3-70b-free',
    freeBetaId: 'mistral-small-free',
    teamLabel: 'Semantic Precision Guild',
    rationale: 'Captures subtle contextual nuances and enforces precise negative constraints without hallucination.',
  ...
  'hum-2': {
    ...
    freeAlphaId: 'llama-3.3-70b-free',
    freeBetaId: 'mistral-small-free',
    teamLabel: 'Policy & Compliance Council',
  ...
  'hum-3': {
    ...
    freeAlphaId: 'qwen-2.5-72b-free',
    freeBetaId: 'gemini-2.5-flash-free',
    teamLabel: 'Executive Synthesis Bureau',
    rationale: 'Consolidates multi-disciplinary perspectives into coherent, authoritative executive deliverables.',
    recommendedRoleAlpha: 'Lead Synthesizer',
    recommendedRoleBeta: 'Cross-Domain Validator',
  },
  'rea-1': {
    nodeId: 'rea-1',
    primaryAlphaId: 'gemini-3.7-flash',
    ...
    freeAlphaId: 'gemini-2.5-flash-free',
    freeBetaId: 'qwen-2.5-72b-free',
    teamLabel: 'Problem Decomposition Unit',
  ...
  'rea-2': {
    ...
    freeAlphaId: 'llama-3.3-70b-free',
    freeBetaId: 'qwen-2.5-72b-free',
    teamLabel: 'Analogical Reasoning Circle',
  ...
  'rea-3': {
    ...
    freeAlphaId: 'gemini-2.5-flash-free',
    freeBetaId: 'deepseek-r1-free',
    teamLabel: 'System Orchestration Swarm',
  ...
  'hyb-legendary-sovereign': {
    ...
    freeAlphaId: 'gemini-2.5-flash-free',
    freeBetaId: 'deepseek-r1-free',
    teamLabel: 'Universal Swarm Vanguard',
